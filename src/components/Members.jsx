...
function CreateMember(props){
    ...
    return(
        <div className='w-[900px]  pl-[60px] py-2 inline-flex gbg-gradient-to-r from-rose-100 to-teal-100'>
            <div className=' bg-gradient-to-r  from-gray-200 via-gray-400 to-gray-600 py-8  border-4 rounded-3xl  ' >
                <div className='h-[300px] flex flex-row p-20 gap-3'  > 
                    <img className='w-[130px] rounded-md pr-5 mr-10 h-[160px] ' src={img} alt="" />
